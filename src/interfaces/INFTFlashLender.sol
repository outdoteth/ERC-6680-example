...
interface INFTFlashLender {
    /// @dev The address of the token used to pay flash loan fees. If it's address(0) then the flash fee token is ETH.
    /// @return The address of the token used to pay flash loan fees.
